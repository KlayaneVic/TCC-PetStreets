...
<?php
	...
	if ($nome_Nova_foto != null){
		$SQL = verificaAtt_Animal_Adm($Nova_cor, $Novo_nome_Animal, $Nova_especie, $Nova_raca, $Novo_porte, $Novo_sexo, $Nova_idade, $Nova_observacoes, $nome_Nova_foto, $id_animal, $novo_status);	
													
	}else{
		$SQL = verificaAtt_Animal_Adm2($Nova_cor, $Novo_nome_Animal, $Nova_especie, $Nova_raca, $Novo_porte, $Novo_sexo, $Nova_idade, $Nova_observacoes, $id_animal, $novo_status);											
	}
